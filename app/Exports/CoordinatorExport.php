...
class CoordinatorExport implements FromCollection, ShouldAutoSize, WithHeadings, WithTitle, WithMapping, WithColumnFormatting
{
    ...
    {
        return Voter::where('level', true)->orderBy('village_id', 'asc')->orderBy('voting_place_id', 'asc')->orderBy('name', 'asc')->get();
    }
    ...
    public function map($voter): array
    {
        return [
            ...
            empty($voter->member) ? '-' : $voter->member->count(),
        ];
    }
