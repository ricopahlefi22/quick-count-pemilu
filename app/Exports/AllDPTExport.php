...
class AllDPTExport implements FromCollection, ShouldAutoSize, WithHeadings, WithTitle, WithMapping, WithColumnFormatting
{
    ...
    {
        return Voter::orderBy('coordinator_id', 'asc')->orderBy('name', 'asc')->get();
    }
