...
class VillageNotVoterExport implements FromCollection, ShouldAutoSize, WithHeadings, WithTitle, WithMapping, WithColumnFormatting
{
    ...
    {
        return Voter::where('village_id', $this->village)->whereNull('coordinator_id')->orderBy('name', 'asc')->get();
    }
