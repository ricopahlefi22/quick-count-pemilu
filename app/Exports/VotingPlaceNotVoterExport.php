...
class VotingPlaceNotVoterExport implements FromCollection, ShouldAutoSize, WithHeadings, WithTitle, WithMapping, WithColumnFormatting
{
    ...
    {
        return Voter::where('voting_place_id', $this->votingPlaceId)->whereNull('coordinator_id')->orderBy('name', 'asc')->get();
    }
