<div id="witnessModal" class="modal fade" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form" action="{{ url('witnesses/store') }}" method="POST">
                @csrf
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button id="button" type="submit"
                        class="btn btn-primary waves-effect waves-light" disabled>Simpan</button>
                </div>
            </form>
        </div>
        <!-- /.modal-content -->
