                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-8 mb-2">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6 mb-2">
                                    <label title="Wajib Diisi" for="e_ktp_record_state" class="form-label">Status
                                        Perekaman KTP-Elektronik</label>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input id="bKTP" class="form-check-input" value="B"
                                                    type="radio" name="e_ktp_record_state">
                                                <label for="bKTP" class="form-check-label">Belum Rekam</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input id="sKTP" class="form-check-input" value="S"
                                                    type="radio" name="e_ktp_record_state">
                                                <label for="sKTP" class="form-check-label">Sudah Rekam
                                                    (Suket)</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input id="kKTP" class="form-check-input" value="K"
                                                    type="radio" name="e_ktp_record_state">
                                                <label for="kKTP" class="form-check-label">Sudah Rekam
                                                    (E-KTP)</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-lg-6 mb-2">
                                    <label title="Wajib Diisi" for="disability_information"
                                        class="form-label">Disabilitas
                                        <span class="text-secondary">(kosongkan jika tidak
                                            memiliki disabilitas)</span></label>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input class="form-check-input" value="0" type="radio"
                                                    name="disability_information">
                                                <label class="form-check-label">0. Tidak Ada</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input class="form-check-input" value="1" type="radio"
                                                    name="disability_information">
                                                <label class="form-check-label">1. Dis. Fisik</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input class="form-check-input" value="2" type="radio"
                                                    name="disability_information">
                                                <label class="form-check-label">2. Dis. Intelektual</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input class="form-check-input" value="3" type="radio"
                                                    name="disability_information">
                                                <label class="form-check-label">3. Dis. Mental</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input class="form-check-input" value="4" type="radio"
                                                    name="disability_information">
                                                <label class="form-check-label">4. Dis. Sensorik</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
